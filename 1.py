...
RETRY_DELAY = 35  # Seconds between retries
...
def main():
    print("Title: GaiaAI Chatbot (FORKED BY KriptoQraf)")
    print("Created by: KriptoQrafTV")
    print("Twitter: https://x.com/khudatzada")
